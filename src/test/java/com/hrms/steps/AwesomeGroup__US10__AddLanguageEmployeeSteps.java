...
public class AwesomeGroup__US10__AddLanguageEmployeeSteps extends CommonMethods {
	...
	@Then("user language is added succesfully")
	public void user_language_is_added_succesfully() {

		String expected = "Turkcee";
		String actual = viewEmp.LanguagesTurkcee.getText();
		Assert.assertEquals("Turkcee language text is displayed correctly", expected, actual);
